...
<head>
    ...
    <link rel="stylesheet" href="view/style/inicial.css">
</head>
<body>
    <header>
    ...
    <section id="sobre">
        ...
        <div class="imagens-sobre">
            <img src="view/img/ACAD1.jpg" alt="Foto da academia Gyga Fit 1" class="imagem-sobre">
            <img src="view/img/ACAD2.jpg" alt="Foto da academia Gyga Fit 2" class="imagem-sobre">
            <img src="view/img/ACAD3.jpg" alt="Foto da academia Gyga Fit 3" class="imagem-sobre">
            <img src="view/img/ACAD4.jpg" alt="Foto da academia Gyga Fit 4" class="imagem-sobre">
        </div>
    </section>
    ...
    <section id="professores">
        ...
        <div class="imagens-professores">
            <img src="view/img/PROF1.jpg" alt="Foto do PROFESSOR Gyga Fit 1" class="imagem-professores">
            <img src="view/img/PROF2.jpg" alt="Foto do PROFESSOR Gyga Fit 2" class="imagem-professores">
            <img src="view/img/PROF3.jpg" alt="Foto do PROFESSOR Gyga Fit 3" class="imagem-professores">
            <img src="view/img/PROF4.jpg" alt="Foto do PROFESSOR Gyga Fit 4" class="imagem-professores">
        </div>
    </section>
