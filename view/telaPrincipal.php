...
<body>
    ...
    <div class="sidebar-modern" id="sidebar">
        ...
        <nav class="sidebar-nav">
            <a href="editar_perfil.php" class="sidebar-link">
            ...
            <a href="./menuAcademia.php" class="sidebar-link">
                <i class="fas fa-dumbbell"></i>
            ...
            <div class="workout-schedule-card">
                ...
                <div class="workouts-container">
                                                ...
                                                <div class="exercise-header">
                                                    ...
                                                    <div class="exercise-info">
                                                        ...
                                                        <div class="exercise-category">
                                                            ...
                                                            if (strpos($exerciseName, 'supino') !== false || strpos($exerciseName, 'peito') !== false) {
                                                                $category = 'Peito';
                                                            } elseif (strpos($exerciseName, 'remada') !== false || strpos($exerciseName, 'costas') !== false) {
                                                                $category = 'Costas';
                                                            } elseif (strpos($exerciseName, 'agachamento') !== false || strpos($exerciseName, 'leg') !== false) {
                                                                $category = 'Pernas';
                                                            } elseif (strpos($exerciseName, 'rosca') !== false || strpos($exerciseName, 'bíceps') !== false) {
                                                                $category = 'Bíceps';
                                                            } elseif (strpos($exerciseName, 'tríceps') !== false) {
                                                                $category = 'Tríceps';
                                                            } elseif (strpos($exerciseName, 'desenvolvimento') !== false || strpos($exerciseName, 'ombro') !== false) {
                                                                $category = 'Ombros';
                                                            } else {
                                                                $category = 'Geral';
                                                            }
                    ...
                    <div class="new-workout-section">
                        <button class="new-workout-button" onclick="window.location.href='./paginaFormulario.php'">
