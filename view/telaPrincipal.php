...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <h3>Menu</h3>
        <a href="editar_perfil.php">Alterar Perfil</a>
        ...
        <div class="info-container">
            <div class="aluno-info">
                ...
                <?php if (!empty($_SESSION['usuario']['foto'])): ?>
                    <img src="../view/uploads/<?php echo htmlspecialchars($_SESSION['usuario']['foto']); ?>" alt="Foto do aluno"
                        class="foto-aluno">
                <?php else: ?>
                    <img src="./img/user-placeholder.png" alt="Sem foto" class="foto-aluno">
                <?php endif; ?>
                <p><strong>Nome:
                    </strong><?= htmlspecialchars($_SESSION['usuario']['username']) ?? 'Usuário não autenticado'; ?>
                </p>
                <p><strong>Plano:
                    </strong><?= htmlspecialchars(plano($_SESSION['usuario']['plano'])) ?? 'Não disponível'; ?></p>
                <p><strong>Tempo restante:
                    </strong><?= htmlspecialchars(diffData($_SESSION['usuario']['data_inicio'], $_SESSION['usuario']['data_termino'])) ?? 'Não disponível'; ?>
                </p>
                <p><strong>instrutor:
                    </strong><?= htmlspecialchars((string) nomeInstrutor($_SESSION['usuario']['id'])) ?? 'Não disponível'; ?>
                </p>
            ...
            <div class="treinos-container">
                            ...
                            <?php foreach ($treinos as $treino): ?>
                                <?php if ($treino['letra_treino'] == $letraObj['letra_treino']): ?>
                                    ...
                                    <?php if ($exercicioInfo): ?>
                                        <li>
                                            <div><span
                                                    class="titulo-exercicio"><?= htmlspecialchars($exercicioInfo['nome_exercicio']) ?></span>
                                            </div>
                ...
                <div class="botao-container">
                    <button class="botao-novo-treino" id="botao-novo-treino"
                        onclick="window.location.href='./paginaFormulario.php'">Solicitar Novo Treino</button>
                </div>
                ...
                <div class="footer-info">
                    <div class="company-info">
                        ...
                        <div class="company-text">
                            <h3>Gyga Fit</h3>
                            <p>Na Gyga Fit, acreditamos em tornar a academia acessível para todos. Nossa abordagem é
                                simples e eficaz, ajudando você a atingir seus objetivos de saúde e bem-estar com
                                facilidade.</p>
                        </div>
                    </div>
